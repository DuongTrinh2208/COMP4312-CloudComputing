...
def list_files():
    """
        http://127.0.0.1:8080/list_files?bucket_name=comp4312_0892995
    """
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_0892995', type=str)
        file_names = []
        #####################
        # Your code is here #
        ####################
...
def create_bk():
    """
        http://127.0.0.1:8080/create_bk?bucket_name=comp4312_0892995dt
    """
    try:
        bucket_name = ""
        #####################
        ...
        bucket_name = request.args.get('bucket_name', default='comp4312_0892995dt', type=str)
